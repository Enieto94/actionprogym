...
<body>
			...
			<section class="row" id="menu">
				<ul class="d-none d-lg-flex ">
					<li>
						...
						<a href="./index.html" target="_blank"><img src="./src/img/logo.png" alt="" id="logo"></a>
					...
					<li><a href="#registrate" class="link" rel="noopener noreferrer">Regístrate</a></li>
					<li><a target="_blank"
				...
				<ul class="d-flex d-lg-none flex-column  align-items-baseline m-0 p-0" id="menu-mobile">
					...
					<li class="item-mm"><a class="link" href="#registrate" target="_blank"
							rel="noopener noreferrer">Regístrate</a>
					</li>
		...
		<div class="container-fluid">
			<section id="inicio">
				<div class="owl-carousel owl-theme" id="carousel-index">
						...
						<div class="cover">
							<div class="container">
								<div class="header-content fade-in">
									...
									<h4>
										Con más de 3 Sedes en Cundinamarca, Acércate y disfruta de los beneficios que
										tenemos para tí!
									</h4>
								</div>
							</div>
					...
					<div class="item">
						<img src="./src/img/slide-1.jpg" alt="">
						<div class="cover">
						</div>
					</div>

					<div class="item">
						<img src="./src/img/slide-2.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-4.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-5.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-6.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-7.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-8.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-9.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-10.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-11.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-12.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-13.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-14.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-15.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-16.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-17.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-18.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-19.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-20.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-21.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-22.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-23.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-24.jpg" alt="">
						<div class="cover">
						</div>
					</div>
					<div class="item">
						<img src="./src/img/slide-25.jpg" alt="">
						<div class="cover">
						</div>
					</div>
			...
			<section class="row justify-content-around text-center py-md-5">

				<div class="col-12">
					<div class="row">
						<h2 class="my-4 text-white service-title">NUESTROS PLANES</h2>
					</div>
				</div>
				<div class="col-10 col-lg-3 card mb-4 box-shadow">
					...
					<div class="card-body">
						<h1 class="card-title pricing-card-title">$90.000 <small class="text-muted"></small>
						</h1>
						<ul class="list-unstyled mt-3 mb-4">

						</ul>
						<button type="button" class="btn btn-lg  btn-warning"><a target="_blank"
								href="https://api.whatsapp.com/send?phone=+573138464688&text=Quiero%20Inscribirme%20en%20ActionProGym%20Plan%20Mensual,%20dame%20m%C3%A1s%20informaci%C3%B3n%20%F0%9F%92%AA">¡LO
								QUIERO!</a></button>
					</div>
				</div>
				<div class="col-10 col-lg-3 card mb-4 box-shadow">
					...
					<div class="card-body">
						<h1 class="card-title pricing-card-title">$240.000<small class="text-muted"></small>
						</h1>
						<ul class="list-unstyled mt-3 mb-4">

						</ul>
						<button type="button" class="btn btn-lg btn-block btn-warning"><a target="_blank"
								href="https://api.whatsapp.com/send?phone=+573138464688&text=Quiero%20Inscribirme%20en%20ActionProGym%20Plan%20Trimestral,%20dame%20m%C3%A1s%20informaci%C3%B3n%20%F0%9F%92%AA">¡LO
								QUIERO!</a></button>
					</div>
				</div>
				<div class="col-10 col-lg-3 card mb-4 box-shadow">
					...
					<div class="card-body">
						<h1 class="card-title pricing-card-title">$399.999 <small class="text-muted"></small>
						</h1>
						<ul class="list-unstyled mt-3 mb-4">

						</ul>
						<button type="button" class="btn btn-lg btn-block btn-warning"><a target="_blank"
								href="https://api.whatsapp.com/send?phone=+573138464688&text=Quiero%20Inscribirme%20en%20ActionProGym%20Plan%20Semestral,%20dame%20m%C3%A1s%20informaci%C3%B3n%20%F0%9F%92%AA">¡LO
								QUIERO!</a></button>
					</div>
				</div>
				<div class="col-10 col-lg-3 card mb-4 box-shadow">
					...
					<div class="card-body">
						<h1 class="card-title pricing-card-title">$650.000 <small class="text-muted"></small>
						</h1>
						<ul class="list-unstyled mt-3 mb-4">

						</ul>
						<button type="button" class="btn btn-lg btn-block btn-warning"><a target="_blank"
								href="https://api.whatsapp.com/send?phone=+573138464688&text=Quiero%20Inscribirme%20en%20ActionProGym,%20dame%20m%C3%A1s%20informaci%C3%B3n%20%F0%9F%92%AA">¡LO
								QUIERO!</a></button>
					</div>
				</div>
			...
			<section class="row justify-content-around" id="sedes">
				<h2 class="text-white service-title">NUESTRAS SEDES</h2>
			...
			<section class="row justify-content-center text-center">
				<h2 class="text-white service-title">NUESTRA UBICACIÓN</h2>
				<iframe
					...
					<div class="row">
						<div class="container-form">
							...
							<form action="/action_page.php">
								...
								<input type="text" id="name" name="name" placeholder="ingresa tu correo">

								<label for="subject">Mensaje</label>
								<textarea id="subject" name="subject" placeholder="" style="height:200px"></textarea>
								<label for="" class="form-control"
									style="background: transparent;color: var(--primary);border: 0;">
									<input type="checkbox" name="tyc" id="tyc" class="mb-4">
									Acepto <a href="http://" target="_blank" rel="noopener noreferrer">Términos y
										condiciones</a>
								</label>

								<input type="submit" value="Enviar" class="text-black"> -->
								...
								<script>
									hbspt.forms.create({
										region: "na1",
										portalId: "23917549",
										formId: "b7c15390-2621-4106-998b-d0d18d63a130"
									});
								</script>
							</form>
						</div>
	...
	<script type="text/javascript" id="hs-script-loader" async defer src="//js.hs-scripts.com/23917549.js"></script>
