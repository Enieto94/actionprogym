...
<head>
    ...
    <title>Planes | ActionPro GYM </title>
        ...
        <div class="container-fluid">
            ...
            <section class="row justify-content-around">
                <div class="col-10 col-lg-3 card mb-4 box-shadow">
                    ...
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title">COP $199.000<small class="text-muted"></small>
                        </h1>
                        <ul class="list-unstyled mt-3 mb-4">
                            ...
                            <li>
                                <i>Además por adquirir tu plan trimestral, Te regalamos <span class="amarillo">15 días
                                        gratis</span> </i>
                            </li>
                        </ul>
                        <button type="button" class="btn btn-lg btn-block btn-warning"><a target="_blank"
                                href="https://api.whatsapp.com/send?phone=+573138464688&text=Quiero%20Inscribirme%20en%20ActionProGym%20Plan%20Trimestral,%20dame%20m%C3%A1s%20informaci%C3%B3n%20%F0%9F%92%AA">ADQUIRIR</a></button>
                    </div>
                </div>
                ...
                <div class="col-10 col-lg-3 card mb-4 box-shadow">
                    ...
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title">COP $399.000<small class="text-muted"></small>
                        </h1>
                        <ul class="list-unstyled mt-3 mb-4">
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <li>
                                <i>Además por adquirir tu plan trimestral, Te regalamos <span class="amarillo">1 mes
                                        gratis</span> </i>
                            </li>
                        </ul>
                        <button type="button" class="btn btn-lg btn-block btn-warning"><a target="_blank"
                                href="https://api.whatsapp.com/send?phone=+573138464688&text=Quiero%20Inscribirme%20en%20ActionProGym%20Plan%Semestral,%20dame%20m%C3%A1s%20informaci%C3%B3n%20%F0%9F%92%AA">ADQUIRIR</a></button>
                    </div>
                </div>
                ...
                <div class="col-10 col-lg-3 card mb-4 box-shadow">
                    ...
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title">COP $599.000<small class="text-muted"></small>
                        </h1>
                        <ul class="list-unstyled mt-3 mb-4">
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <li>
                                <i>Además por adquirir tu plan trimestral, Te regalamos <span class="amarillo">2 Meses
                                        gratis</span> </i>
                            </li>
                        </ul>
                        <button type="button" class="btn btn-lg btn-block btn-warning"><a target="_blank"
                                href="https://api.whatsapp.com/send?phone=+573138464688&text=Quiero%20Inscribirme%20en%20ActionProGym%20Plan%Anual,%20dame%20m%C3%A1s%20informaci%C3%B3n%20%F0%9F%92%AA">ADQUIRIR</a></button>
                    </div>
                </div>
            </section>
